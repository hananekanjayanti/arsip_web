<?php 
$admin = $this->db->where('id',$this->session->userdata('sekcam'))->get('pegawai')->result();
?>
...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
  ...
  <div class="main-menu-content">
    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
      ...
      <li class=" nav-item"><a href="<?php echo base_url('sekcam/masuk') ?>"><i class="fa fa-envelope"></i><span data-i18n="nav.dash.main" class="menu-title">Surat Masuk</span></a>
      </li>
      <li class=" nav-item"><a href="<?php echo base_url('sekcam/keluar') ?>"><i class="fa fa-envelope-o"></i><span data-i18n="nav.dash.main" class="menu-title">Surat Keluar</span></a>
      </li>
      ...
      <li class=" nav-item"><a href="<?php echo base_url('sekcam/laporan') ?>"><i class="fa fa-file"></i><span data-i18n="nav.dash.main" class="menu-title">Laporan Rekapitulasi</span></a>
      </li>
