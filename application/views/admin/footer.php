...
<footer style="width: 100%;left: 0;position: fixed;bottom: 0" class="footer footer-static footer-light navbar-border">
  <p class="clearfix text-muted text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 2018 <a href="https://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" target="_blank" class="text-bold-800 grey darken-2">ArsipSurat </a>, All rights reserved. </span></p>
</footer>
...
<script src='<?php echo base_url('assets/calendar/dist/') ?>fullcalendar.min.js'></script>
<script src="<?php echo base_url('assets/calendar/dist/') ?>call-inits.js"></script>
