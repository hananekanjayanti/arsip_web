<?php 
$admin = $this->db->where('id',$this->session->userdata('staff'))->get('pegawai')->result();
?>
...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
  ...
  <div class="main-menu-content">
    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
      ...
      <li class=" nav-item"><a href="<?php echo base_url('staff/kategori') ?>"><i class="fa fa-th-large"></i><span data-i18n="nav.dash.main" class="menu-title">Kategori</span></a>
      </li>
      <li class=" nav-item"><a href="#"><i class="fa fa-envelope"></i><span data-i18n="nav.advance_cards.main" class="menu-title">Kelola Surat</span></a>
        <ul class="menu-content">
          <li><a href="<?php echo base_url('staff/masuk') ?>" data-i18n="nav.cards.masuk" class="menu-item">Surat Masuk</a>
          </li>
          <li><a href="<?php echo base_url('staff/keluar') ?>" data-i18n="nav.cards.keluar" class="menu-item">Surat Keluar</a>
          </li>
        </ul>
      </li>
      <li class=" nav-item"><a href="<?php echo base_url('staff/disposisi') ?>"><i class="fa fa-envelope-open"></i><span data-i18n="nav.dash.main" class="menu-title">Disposisi Surat</span></a>
      </li>
      <li class=" nav-item"><a href="<?php echo base_url('staff/tugas') ?>"><i class="fa fa-calendar"></i><span data-i18n="nav.dash.main" class="menu-title">Monitoring Tugas</span></a>
      </li>
      <li class=" nav-item"><a href="<?php echo base_url('staff/laporan') ?>"><i class="fa fa-file"></i><span data-i18n="nav.dash.main" class="menu-title">Laporan Rekapitulasi</span></a>
      </ul>
    </div>  
  </div>
  <!-- / main menu-->
        ...
        <script>
          function cek() {
            if ($("#lama").val()!=='') {
              $.ajax({
                type: "GET",
                url: "<?php echo base_url('staff/carilama/') ?>"+$("#lama").val(),
          ...
          function cekusername() {
            if ($("#user").val()!=='') {
              $.ajax({
                type: "GET",
                url: "<?php echo base_url('staff/cariusername/') ?>"+$("#user").val(),
                success: function (data) {
                  var dataa = data;
                  if (dataa==1) {
