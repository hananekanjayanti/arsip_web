								...
								<tbody id="isi">
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo base_url('kasubag/detmasuk/'.$key->id) ?>" class="btn btn-outline-primary" data-toggle="tooltip" title="Detail Surat Masuk"><i class="fa fa-search"></i></a>
											<a href="<?php echo base_url('kasubag/delmasuk/'.$key->id) ?>" class="btn btn-outline-danger" data-toggle="tooltip" onclick="return confirm('Hapus surat masuk?')" title="Hapus Surat Masuk"><i class="fa fa-trash"></i></a>
...
<div class="modal fade text-xs-left" id="update<?php echo $e->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<form method="post" action="<?php echo base_url('kasubag/updatemasuk/'.$e->id) ?>" enctype="multipart/form-data">
