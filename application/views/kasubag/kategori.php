					...
					<div class="card-body">
						...
						<div class="table-responsive m-t-40" style="margin-bottom: 15px;">
							<table cellspacing="0" class="display nowrap table table-hover table-striped table-bordered tableku" width="100%">
								...
								<tbody id="isi">
									<?php $no = 0; foreach ($kategori->result() as $key): $no++;?>
									<tr>
										<td><?php echo $no ?></td>
										<td><?php echo $key->kategori ?></td>
										<td>
											<button class="btn btn-outline-success" data-toggle="modal" data-target="#update<?php echo $key->id ?>"><i data-toggle="tooltip" title="Update kategori" class="fa fa-edit"></i></button>
											<a href="<?php echo base_url('kasubag/delkategori/'.$key->id) ?>" class="btn btn-outline-danger" data-toggle="tooltip" onclick="return confirm('Hapus kategori?')" title="Hapus kategori"><i class="fa fa-trash"></i></a>
...
<?php foreach ($kategori->result() as $e): ?>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel1">update kategori</h4>
			</div>
			<form method="post" action="<?php echo base_url('kasubag/updatekategori/'.$e->id) ?>" enctype="multipart/form-data">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label for="">Kategori</label>
								<input type="text" value="<?php echo $key->kategori ?>" class="form-control" required="" name="kategori">
							</div>
						</div>
					</div>
				</div>
...
<div class="modal fade text-xs-left" id="tambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form method="post" action="<?php echo base_url('kasubag/addkategori') ?>" enctype="multipart/form-data">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
