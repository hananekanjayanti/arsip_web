                ...
                <div class="card border-grey border-lighten-3 m-0">
                    <div class="card-header no-border">
                        <div class="card-title text-xs-center">
                            <div class="p-1"><h3><b style="font-size: 1.5em;font-weight: bolder;text-shadow: 2px 2px 2px gray"><span style="color: #ac92ec;">Aplikasi pembuatan surat</span></b></h3></div>
                        </div>
