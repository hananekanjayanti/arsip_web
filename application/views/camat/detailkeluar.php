					...
					<div class="card-body">
						<div class="col-md-12" style="padding-bottom: 20px;">
							<div class="table-responsive">
								...
								<a href="<?php echo base_url('camat/keluar') ?>" class="btn btn-outline-danger">Kembali</a>
								<br>
							</div>
						</div>
					</div>
...
<div class="modal fade text-xs-left" id="update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<form method="post" action="<?php echo base_url('camat/updatekeluar/'.$lama[0]->id) ?>" enctype="multipart/form-data">
