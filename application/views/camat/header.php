<?php 
$admin = $this->db->where('id',$this->session->userdata('camat'))->get('pegawai')->result();
?>
...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
  ...
  <div class="main-menu-content">
    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
      <li class=" nav-item"><a href="<?php echo base_url('camat') ?>"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Dashboard</span></a>
      </li>
      <li class=" nav-item"><a href="<?php echo base_url('camat/masuk') ?>"><i class="fa fa-envelope"></i><span data-i18n="nav.dash.main" class="menu-title">Surat Masuk</span></a>
      </li>
      <li class=" nav-item"><a href="<?php echo base_url('camat/keluar') ?>"><i class="fa fa-envelope-o"></i><span data-i18n="nav.dash.main" class="menu-title">Surat Keluar</span></a>
      </li>

      <li class=" nav-item"><a href="<?php echo base_url('camat/disposisi') ?>"><i class="fa fa-envelope-open"></i><span data-i18n="nav.dash.main" class="menu-title">Disposisi Surat</span></a>
      </li>


      <li class=" nav-item"><a href="<?php echo base_url('camat/laporan') ?>"><i class="fa fa-file"></i><span data-i18n="nav.dash.main" class="menu-title">Laporan Rekapitulasi</span></a>
      </li>
    </ul>
  </div>  
</div>
      ...
      <script>
        function cek() {
          if ($("#lama").val()!=='') {
            $.ajax({
              type: "GET",
              url: "<?php echo base_url('camat/carilama/') ?>"+$("#lama").val(),
        ...
        function cekusername() {
          if ($("#user").val()!=='') {
            $.ajax({
              type: "GET",
              url: "<?php echo base_url('camat/cariusername/') ?>"+$("#user").val(),
              success: function (data) {
                var dataa = data;
                if (dataa==1) {
